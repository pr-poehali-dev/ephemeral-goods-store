    ...
    <Card className="group hover:shadow-md transition-all duration-200 border-2 border-gray-600 bg-gray-200">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex border-4 border-black rounded overflow-hidden h-8 bg-blue-900 shadow-lg">
            {Array.from({ length: 20 }, (_, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`flex-1 transition-all duration-200 border-r-2 border-blue-800 last:border-r-0 ${
                    isAvailable
