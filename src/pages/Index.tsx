    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50">
      ...
      <div className="container mx-auto px-6 py-12 bg-slate-300">
        <div className="text-center mb-12">
          ...
          <p className="text-lg max-w-2xl mx-auto text-[#000000]">Выберите нужные эмоции и добавьте их в свою жизнь. Каждое деление 1товар стоит 200р , после покупки товар будет активирован и скоро начнет действовать</p>
        </div>
      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="mt-4 text-xs text-gray-500 border-t border-gray-700 pt-4">ИП Паклин Сергей Васильевич, ИНН 594200005879 ОГРН 305591619400016 эл.почта: unix7777@ya.ru, тел: 89024777752</div>
        </div>
      </footer>
    </div>
  );
